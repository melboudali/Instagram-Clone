...
const NavbarMenuMenu = styled.div<{ showMenu: boolean }>`
...
const NavbarMenuBubble = styled.div`
	left: 184px;
	bottom: 0;
	top: -6px;
	background: #fff;
...
const NavbarMenu = ({ meData: { username }, showMenu }: NavbarMenuProps) => (
	<NavbarMenuContainer>
		<NavbarMenuMenu showMenu={showMenu}>
			<NavbarMenuBubble />
			<NavbarMenuList>
				<NavbarMenuLink linkName="profile" to={`/${username}`}>
				...
				<NavbarMenuLink linkName="saved" to="#">
					<svg fill="#262626" height="16" viewBox="0 0 32 32" width="16">
				...
				<NavbarMenuLink linkName="switch accounts" to="#">
					<svg fill="#262626" height="16" viewBox="0 0 32 32" width="16">
